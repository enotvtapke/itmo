<template>
    <article>
        <a href="#" @click.prevent="$root.changePage('Post', {post: post})" class="title">{{ post.title }}</a>
        ...
        <div class="footer">
            ...
            <div class="right">
                ...
                <a href="#" @click.prevent="$root.changePage('Post', {post: post})">{{ Object.keys(post.comments).length }}</a>
            </div>
        </div>
    </article>
</template>
