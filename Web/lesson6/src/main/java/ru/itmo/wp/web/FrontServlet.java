...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        try {
            page.before(request, view);
            actionMethod.setAccessible(true);
            actionMethod.invoke(page, request, view);
            page.after(request, view);
        } catch (Exception e) {
            if (e instanceof InvocationTargetException) {
                e = (Exception) e.getCause();
            }
            if (e instanceof RedirectException) {
                RedirectException redirectException = (RedirectException) e;
                ...
                throw new ServletException("Unable to run action [pageClass=" + pageClass + "].", e);
            }
        }
