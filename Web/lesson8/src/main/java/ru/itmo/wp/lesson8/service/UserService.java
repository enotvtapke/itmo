...
public class UserService {
    ...
    public void updateDisable(UserStatus userStatus) {
        if (userStatus.getId() != null && userStatus.isDisabled() != null) {
            userRepository.updateDisabled(userStatus.getId(), userStatus.isDisabled());
        }
    }
